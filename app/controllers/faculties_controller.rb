class FacultiesController < ApplicationController
  before_action :authenticate_faculty!, except: [:edit, :update]
  ...
  def home
    @faculty = Faculty.find(current_faculty.id)
  end
  ...
  def faculty_params
    params.require(:faculty).permit(:name, :phone, :department, :university, :approved, :administrator_id, :course_ids => [])
  end
