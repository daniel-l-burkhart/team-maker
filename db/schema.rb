...
ActiveRecord::Schema.define(version: 20) do
  ...
  create_table 'answers', id: :serial, force: :cascade do |t|
    ...
    t.index %w(response_id question_id), name: 'index_answers_on_response_id_and_question_id', unique: true
  ...
  create_table 'courses_students', id: false, force: :cascade do |t|
    ...
    t.index %w(course_id student_id), name: 'index_courses_students_on_course_id_and_student_id', unique: true
  end
  ...
  create_table 'responses', id: :serial, force: :cascade do |t|
    ...
    t.index %w(survey_id student_id), name: 'index_responses_on_survey_id_and_student_id', unique: true
  ...
  create_table 'students', id: :serial, force: :cascade do |t|
    ...
    t.index %w(student_id university), name: 'index_students_on_student_id_and_university', unique: true
  ...
  create_table 'students_teams', id: false, force: :cascade do |t|
    ...
    t.index %w(student_id team_id), name: 'index_students_teams_on_student_id_and_team_id', unique: true
  end
  ...
  create_table 'teams', id: :serial, force: :cascade do |t|
    ...
    t.index %w(id survey_id), name: 'index_teams_on_id_and_survey_id', unique: true
