...
=begin
  ...
  test "should update administrator" do
    patch :update, id: @administrator, administrator: {department: @administrator.department, name: @administrator.name, phone: @administrator.phone, university: @administrator.university}
